...
class AgendamentoPolimento extends StatefulWidget {
  const AgendamentoPolimento({super.key});

  @override
  _AgendamentoPolimentoState createState() => _AgendamentoPolimentoState();
}

class _AgendamentoPolimentoState extends State<AgendamentoPolimento> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Agendamento Polimento',
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Descrição\n\n'
                'Polimento detalhado do veículo para restaurar o brilho da pintura e remover pequenos arranhões.',
