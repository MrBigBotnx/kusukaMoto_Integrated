...
class AgendamentoExterno extends StatefulWidget {
  const AgendamentoExterno({super.key});

  @override
  _AgendamentoExternoState createState() => _AgendamentoExternoState();
}

class _AgendamentoExternoState extends State<AgendamentoExterno> {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Descrição\n\n'
                'Limpeza completa da parte externa do veículo, incluindo carroceria, janelas e rodas.',
