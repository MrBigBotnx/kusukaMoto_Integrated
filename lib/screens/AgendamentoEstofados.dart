...
class _AgendamentoEstofadosState extends State<AgendamentoEstofados> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Agendamento Estofados',
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Descrição\n\n'
                'Limpeza completa dos estofados, incluindo a remoção de manchas e odores. Ideal para manter o interior do veículo limpo e confortável.',
