...
class AgendamentoDetalhada extends StatefulWidget {
  const AgendamentoDetalhada({super.key});

  @override
  _AgendamentoDetalhadaState createState() => _AgendamentoDetalhadaState();
}

class _AgendamentoDetalhadaState extends State<AgendamentoDetalhada> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Agendamento Detalhada',
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Descrição\n\n'
                'Lavagem detalhada do veículo, incluindo limpeza profunda de todas as áreas internas e externas, polimento e proteção adicional.',
