...
class AgendamentoInterna extends StatefulWidget {
  const AgendamentoInterna({super.key});

  @override
  _AgendamentoInternaState createState() => _AgendamentoInternaState();
}

class _AgendamentoInternaState extends State<AgendamentoInterna> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Agendamento Limpeza Interna',
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Descrição\n\n'
                'Limpeza completa do interior do veículo, incluindo assentos, painéis e tapetes.',
